...
interface Polygon6IconProps extends SVGProps<SVGSVGElement> {
  targetPosition: number;
}

const Polygon6Icon = ({ targetPosition, ...props }: Polygon6IconProps) => {
  ...
  return (
    ...
    onClick={handleButtonClick}
       ...
       />
       <defs>
         <linearGradient id='paint0_linear_146_7' x1={0} y1={37} x2={82} y2={37} gradientUnits='userSpaceOnUse'>
